...
The most low level memory found in FPGAs is distributed RAM. It is a type of on-chip memory, and in contrast to BRAM, distributed RAM utilizes the same CLBs that is common with the logic of the FPGA design. This leads to a tradeoff between the use of CLB resources. If the FPGA design is large there might not be room for distributed RAM, leading to slightly less performant BRAM to be used instead.
% SLICEL SLICEM
