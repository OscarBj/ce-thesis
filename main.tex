...
The documentation of the pre processing pipeline explains the features and technical details of the implemented system. A client endpoint is needed to allow configuration and testing of the FPGA design, which implements the pre processing pipeline. The system is thus distributed as shown in figure  to allow user friendly testing and validation. Figure \ref{fig:overview}

\begin{figure}[h]
    \centering
    \includegraphics[scale=0.2]{figures/overview.png}
    \caption{Diagram of star tracker pre processing pipeline and surrounding components.}
    \label{fig:overview}
\end{figure}
...
\subsubsection{Pre processing pipeline state indicator}

\subsubsection{Image transfer}
