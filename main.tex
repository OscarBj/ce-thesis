...
% Insert example coordinates

% GPS

% Insert example attitude
% Attitude Matrix - Singular value decomposition (SVD)

\section{Pre-processing pipeline}

% Insert example images, system output
