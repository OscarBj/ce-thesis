...
\par
SDRAM features often DDR meaning it works on both rising and falling edge of the clock cycle. This allows the external interface to be double the data width of the SDRAM, and data to be accessed twice during a clock cycle.
\par
Another feature of SDRAM is burst operations. 
\par
