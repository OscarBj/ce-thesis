...
\subsection{SDRAM}
One of the most common storage mechanism is SDRAM which is usefull to store data that is frequently used and ranges from kilobytes to megabytes in size. SDRAM typically has low power consumption and features reasonably high bandwidth. It is often paired with FPGAs because it is next in the memory hierarchy after on chip storage mechanisms.
\par
